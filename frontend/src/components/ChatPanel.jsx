...
const s = {
  ...
  wSignIn: {
    flex: 1, padding: "10px", background: "#111827", color: "#fff",
    border: "none", borderRadius: 10, fontSize: 13, fontWeight: 600,
    cursor: "pointer",
  },
  wSignUp: {
    flex: 1, padding: "10px", background: "transparent", color: "#111827",
    border: "1px solid #111827", borderRadius: 10, fontSize: 13, fontWeight: 600,
    cursor: "pointer",
  },
  wGuest: {
  ...
  sourceChip: {
    ...
    border: "1px solid #d1d5db", fontWeight: 500,
  },
  ...
  confFill: { height: "100%", background: "#111827", borderRadius: 99, transition: "width 0.3s" },
  confLabel: { fontSize: 11, color: "#9ca3af" },
  dots: { display: "flex", gap: 5, padding: "8px 0" },
  dot: {
    width: 7, height: 7, borderRadius: "50%", background: "#111827",
    animation: "dotBounce 1.2s ease infinite", display: "inline-block",
  },
  guestBanner: {
    fontSize: 12, color: "#9ca3af", background: "#1f2937",
  ...
  uploadSpinner: {
    ...
    border: "2px solid #374151", borderTopColor: "#fff",
    animation: "spin 0.7s linear infinite", flexShrink: 0,
  },
  textarea: {
    flex: 1, background: "transparent", border: "none",
    resize: "none", fontSize: 15, lineHeight: "1.55",
    color: "#f9fafb", maxHeight: 160, overflowY: "auto", padding: "2px 4px",
  },
  attachBtn: {
    width: 36, height: 36, borderRadius: 10, background: "transparent", color: "#9ca3af",
    border: "1px solid #374151", cursor: "pointer", flexShrink: 0,
    display: "flex", alignItems: "center", justifyContent: "center",
  },
  attachBtnOff: {
    width: 36, height: 36, borderRadius: 10, background: "transparent", color: "#4b5563",
    border: "1px solid #2d3748", cursor: "not-allowed", flexShrink: 0,
    display: "flex", alignItems: "center", justifyContent: "center",
  },
  sendBtn: {
    width: 36, height: 36, borderRadius: 10, background: "#fff", color: "#111827",
    border: "none", cursor: "pointer", flexShrink: 0,
    display: "flex", alignItems: "center", justifyContent: "center",
  },
  sendBtnOff: {
    width: 36, height: 36, borderRadius: 10, background: "#374151", color: "#6b7280",
